...
class util_class:
    ...
    def test(param):
        ...
        print("This is a test function, declared as test(param), under the parent 'class util_class'\n")
        # This is a test function, declared as test(param), under the parent 'class util_class'
        # This test function was declared inside of index.py of the 'Utilities' library
        #   'library/utilities/index.py'
